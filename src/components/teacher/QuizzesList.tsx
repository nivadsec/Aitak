...
import { Edit, MoreVertical, Trash2, AlertTriangle, FileText } from 'lucide-react';
  ...
  if (quizzes.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-md border-2 border-dashed p-12 text-center">
        <h3 className="text-lg font-semibold">هیچ آزمونی یافت نشد</h3>
      ...
      <Dialog open={!!editingQuiz} onOpenChange={(open) => !open && setEditingQuiz(null)}>
        ...
        <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col">
          <DialogHeader>
            ...
            <DialogDescription>
                اطلاعات و سوالات آزمون را ویرایش کنید.
            </DialogDescription>
          </DialogHeader>
