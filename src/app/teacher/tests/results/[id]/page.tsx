...
import type { Test, TestSubmission, Student } from '@/lib/types';
import { notFound } from 'next/navigation';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Skeleton } from '@/components/ui/skeleton';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { ClipboardList, Percent, User, Calendar } from 'lucide-react';
...
export default function TestResultsPage({ params }: { params: { id: string } }) {
    ...
    const submissionsQuery = useMemoFirebase(() => {
        if (!user || !id) return null;
        return query(collection(firestore, 'teachers', user.uid, 'tests', id, 'submissions'), orderBy('submittedAt', 'desc'));
    }, [firestore, user, id]);
    ...
    const { data: submissions, isLoading: areSubmissionsLoading } = useCollection<TestSubmission>(submissionsQuery);
    ...
    const isLoading = isTestLoading || areSubmissionsLoading || areStudentsLoading;
